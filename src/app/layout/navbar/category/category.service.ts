...
export class CategoryService {
  ...
  private changeCateogry$: BehaviorSubject<Category> = new BehaviorSubject<Category>(this.getCategoryByDefault());
  changeCategoryObs: Observable<Category> = this.changeCateogry$.asObservable();
  //This to notify when user click to another category
  changeCategory(category: Category): void {
    this.changeCateogry$.next(category);
  }
  //This to return the list of all categories
